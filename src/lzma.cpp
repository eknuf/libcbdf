...
const uint32_t no_compression       = 0U;
const uint32_t best_speed           = 1U;
const uint32_t best_compression     = 9U;
const uint32_t default_compression  = LZMA_PRESET_DEFAULT;
...
const int header_error         = LZMA_FORMAT_ERROR;
      ...
      void* derived )
{
    ...
    lzma_error::check(
        compress ?
            lzma_easy_encoder(s, p.level, LZMA_CHECK_CRC64) :
